import { getProductImageUrl } from "../../services/menuService";
...
export const MenuItemCard = ({
  ...
  const validImageUrl = getProductImageUrl(imageSrc ?? null);
  ...
  return (
    ...
    >
      ...
      <h3 className="relative z-10 [font-family:'Montserrat-Bold',Helvetica] font-bold text-white text-3xl text-center drop-shadow-md">
        {title}
      </h3>
    </div>
  );
